...
const createServer = async () => {
    ...
    server.state("mv_access_token", {
        ...
        isSameSite: process.env.NODE_ENV !== "production" ? "Lax" : "None",
        path: "/"
    });
    ...
    server.state("mv_refresh_token", {
        ...
        isSameSite: process.env.NODE_ENV !== "production" ? "Lax" : "None", // CRITICAL: Best protection against CSRF attacks for auth tokens in cross-sites, like communication between a.com & b.com
