...
import { COMPANY_NAME, SUPPORT_EMAIL } from '../constants/business.constants'; // adjust path as needed
import { AUTH } from '../constants/emailSubjects.constants';
import welcomeTemplate from '../email-templates/users/welcome.template';
